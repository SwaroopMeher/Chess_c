    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContentNoOverlay
          ...
          data-mobile="true"
          className={cn(
            'bg-background shadow-xl text-foreground border-r border-gray-200 z-60',
...
// Add a custom SheetContentNoOverlay for mobile sidebar
function SheetContentNoOverlay({ className, children, side = "right", style, ...props }: { className?: string; children?: ReactNode; side?: "top" | "right" | "bottom" | "left"; style?: React.CSSProperties }) {
  return (
    <SheetPortal>
